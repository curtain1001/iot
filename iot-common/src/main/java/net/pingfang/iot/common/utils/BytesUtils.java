package net.pingfang.iot.common.utils;
...
public class BytesUtils {
	...
	/**
	 * 大端模式,字节数组转int,高位字节在前,低字节在后. ------------------------------------ | 31-24位 |
	 * 23-16位 | 15-8位 | 7-0位 | ------------------------------------
	 *
	 * @param src    数组
	 * @param offset 偏移量
	...
	/**
	 * 低位字节数组转int,低字节在后 ------------------------------------- | 31-24位 | 23-17位 |
	 * 16-8位 | 7-0位 | -------------------------------------
	 *
	 * @param src 字节数组
	 * @return int值
	...
	/**
	 * 数字大端模式转字节数组, 低字节在后 ------------------------------------- | 31-24位 | 23-16位 |
	 * 15-8位 | 7-0位 | -------------------------------------
	 *
	 * @param number 数字值
	 * @param target 目标数组
