package com.ruoyi.iot.device.protocol;
...
import com.ruoyi.iot.device.DeviceInfo;
import com.ruoyi.iot.device.DeviceOperator;
import com.ruoyi.iot.device.codec.DeviceMessageCodec;
import com.ruoyi.iot.device.interceptor.DeviceMessageSenderInterceptor;
import com.ruoyi.iot.device.metadata.DeviceMetadata;
import com.ruoyi.iot.device.metadata.DeviceMetadataCodec;
import com.ruoyi.iot.device.metadata.Feature;
...
public interface ProtocolSupport extends Disposable, Ordered, Comparable<ProtocolSupport> {
	 ...
	 * @return 认证结果 // * @see MqttAuthenticationRequest
	 */
//	@Nonnull
...
//	}
	 ...
	 * @since 1.1.4
	 */
//	default Flux<ConfigMetadata> getMetadataExpandsConfig(Transport transport, DeviceMetadataType metadataType,
...
//	}
	 ...
	 * @since 1.1.6
	 */
//	default Mono<Void> onClientConnect(Transport transport, ClientConnection connection, DeviceGatewayContext context) {
//		return Mono.empty();
//	}
	 ...
	 * @return 新等设备信息
	 */
	default Mono<DeviceInfo> doBeforeDeviceCreate(Transport transport, DeviceInfo deviceInfo) {
