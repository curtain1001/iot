...
import static com.ruoyi.iot.device.message.MessageType.UNKNOWN;
...
import com.ruoyi.iot.device.metadata.Jsonable;

/**
 * 设备消息
 *
 * // * @see org.jetlinks.core.message.property.ReadPropertyMessage // * @see
 * org.jetlinks.core.message.property.ReadPropertyMessageReply // * @see
 * org.jetlinks.core.message.property.WritePropertyMessage // * @see
 * org.jetlinks.core.message.property.WritePropertyMessageReply // * @see
 * org.jetlinks.core.message.function.FunctionInvokeMessage // * @see
 * org.jetlinks.core.message.function.FunctionInvokeMessageReply // * @see
 * org.jetlinks.core.message.event.EventMessage // * @see DeviceOnlineMessage //
 * * @see DeviceOfflineMessage // * @see ChildDeviceMessage // * @see
