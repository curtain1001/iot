...
public interface DeviceDataManager {
	 ...
	 * @return 属性数据
	 */
	Mono<PropertyValue> getLastProperty(@Nonnull String deviceId, @Nonnull String propertyId);
	 ...
	 * @return 属性数据
	 */
	Mono<PropertyValue> getLastProperty(@Nonnull String deviceId, @Nonnull String propertyId, long baseTime);
	 ...
	 * @return 属性数据
	 */
	Mono<PropertyValue> getFirstProperty(@Nonnull String deviceId, @Nonnull String propertyId);
	...
	default Mono<Map<String, Object>> getTagMap(@Nonnull String deviceId, String... tagIdList) {
		return this.getTags(deviceId, tagIdList).collectMap(TagValue::getTagId, TagValue::getValue);
	}
