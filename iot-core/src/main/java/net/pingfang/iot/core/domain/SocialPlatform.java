...
public class SocialPlatform extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
				.append("socialPlatformId", getSocialPlatformId()).append("platform", getPlatform())
				.append("status", getStatus()).append("clientId", getClientId()).append("secretKey", getSecretKey())
				.append("redirectUri", getRedirectUri()).append("delFlag", getDelFlag())
				.append("createBy", getCreateBy()).append("createTime", getCreateTime())
				.append("updateTime", getUpdateTime()).append("updateBy", getUpdateBy()).append("remark", getRemark())
				.append("bindUri", getBindUri()).append("redirectLoginUri", getRedirectLoginUri())
				.append("errorMsgUri", getErrorMsgUri()).toString();
	}
