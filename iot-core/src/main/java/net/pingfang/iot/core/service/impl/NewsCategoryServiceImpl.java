...
import net.pingfang.iot.core.domain.NewsCategory;
import net.pingfang.iot.core.mapper.NewsCategoryMapper;
import net.pingfang.iot.core.model.IdAndName;
import net.pingfang.iot.core.service.INewsCategoryService;
