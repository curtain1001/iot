package net.pingfang.iot.core.network.utils;

import java.util.function.Supplier;

public class SystemUtils {

	static float memoryWatermark = Float
			.parseFloat(System.getProperty("memory.watermark", System.getProperty("memory.waterline", "0.1")));

	// 水位线持续
	static long memoryWatermarkDuration = TimeUtils.parse(System.getProperty("memory.watermark.duration", "5s"))
			.toMillis();
