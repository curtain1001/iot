...
import net.pingfang.iot.core.tcp.client.VertxTcpClient;
...
public class VertxTcpServer implements TcpServer {
	...
	protected void acceptTcpConnection(NetSocket socket) {
		...
		try {
			...
			// set方法
			// org.jetlinks.community.network.tcp.server.VertxTcpServer.setParserSupplier
			// 调用坐标
			// org.jetlinks.community.network.tcp.server.TcpServerProvider.initTcpServer
