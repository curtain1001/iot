...
public class ThingsModel extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("modelId", getModelId())
				.append("modelName", getModelName()).append("productId", getProductId())
				...
				.append("datatype", getDatatype()).append("specs", getSpecs()).append("isTop", getIsTop())
				.append("isMonitor", getIsMonitor()).append("createBy", getCreateBy())
