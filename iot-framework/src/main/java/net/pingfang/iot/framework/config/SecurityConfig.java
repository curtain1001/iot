package net.pingfang.iot.framework.config;
...
import net.pingfang.iot.framework.security.filter.JwtAuthenticationTokenFilter;
import net.pingfang.iot.framework.security.handle.AuthenticationEntryPointImpl;
import net.pingfang.iot.framework.security.handle.LogoutSuccessHandlerImpl;
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
				...
				.antMatchers("/login", "/register", "/captchaImage", "/iot/tool/register", "/iot/tool/ntp",
						"/iot/tool/download", "/iot/tool/mqtt/auth", "/iot/tool/mqtt/webhook", "/auth/**/**")
				.anonymous()
				.antMatchers(HttpMethod.GET, "/", "/*.html", "/**/*.html", "/**/*.css", "/**/*.js", "/profile/**")
				.permitAll().antMatchers("/swagger-ui.html").anonymous().antMatchers("/swagger-resources/**")
				.anonymous().antMatchers("/webjars/**").anonymous().antMatchers("/*/api-docs").anonymous()
